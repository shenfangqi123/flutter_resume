...
class CameraRecorderHome extends StatefulWidget {
  final List<CameraDescription> cameras;

  /// Default Constructor
  const CameraRecorderHome({Key? key, required this.cameras}) : super(key: key);
  @override
  State<CameraRecorderHome> createState() {
    return _CameraRecorderHomeState();
  }
}
...
class _CameraRecorderHomeState extends State<CameraRecorderHome> with WidgetsBindingObserver, TickerProviderStateMixin {
