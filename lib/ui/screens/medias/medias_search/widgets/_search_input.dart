...
class _SearchInput extends StatelessWidget {
  const _SearchInput({Key? key, required this.onSubmit, required this.searchSuggestions}) : super(key: key);
  ...
  Iterable<String> _getSuggestions(TextEditingValue textEditingValue) {
    if (textEditingValue.text == '') return searchSuggestions.getRange(0, 10);
